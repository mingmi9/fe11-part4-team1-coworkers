...
export default function ReportSection({
  ...
  return (
    <div>
      ...
      <div className="flex h-[21.7rem] w-[120rem] items-center justify-between gap-[1rem] rounded-[1.2rem] bg-background-secondary p-[2.4rem]">
        <div className="ml-[2rem] flex items-center gap-[3rem]">
          <div className="relative h-[17rem] w-[17rem] rounded-full">
            <div
            ...
            />
            <div className="absolute inset-11 flex items-center justify-center rounded-full bg-background-secondary" />
          </div>
          <div>
