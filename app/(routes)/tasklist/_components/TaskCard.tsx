...
const TaskCard = () => {
  ...
  return (
    <article aria-label="할 일 카드" className="w-full px-[1.4rem] h-[7.4rem] mb-[1.2rem] py-[1.2rem] rounded-[0.8rem] bg-background-secondary hover:bg-background-tertiary transition-colors duration-300 flex flex-col justify-between">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h2 className="text-text-primary text-[1.4rem] mr-[1.2rem]">{mockTaskData.name}</h2>
            <div className="flex items-center gap-1">
              <Image 
                  ...
                  height={16}
                   />
              <span className="text-text-default text-[1.2rem]">{mockTaskData.commentCount}</span>
            </div>
          </div>
          <Dropdown>
            {({ isOpen, toggleDropdown }) => (
              <>
                ...
                <Dropdown.Menu isOpen={isOpen}>
                  <Dropdown.Item toggleDropdown={toggleDropdown}>수정하기</Dropdown.Item>
                  <Dropdown.Item toggleDropdown={toggleDropdown}>삭제하기</Dropdown.Item>
                </Dropdown.Menu>
              </>
            )}
          </Dropdown>
